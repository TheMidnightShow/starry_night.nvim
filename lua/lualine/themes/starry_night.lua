...
M.insert =
{
  a = { bg = c.insert, fg = c.bg, bold = true },
...
M.command =
{
  a = { bg = c.command, fg = c.bg, bold = true },
...
M.visual =
{
  a = { bg = c.visual, fg = c.bg, bold = true },
...
M.replace =
{
  a = { bg = c.replace, fg = c.bg, bold = true },
