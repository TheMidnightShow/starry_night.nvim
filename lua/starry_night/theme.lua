local c = require("starry_night.colors").dark
...
--------------------------------------------------------
  ...
  hl(0, "PmenuThumb",   { fg = 'NONE', bg = c.hint })

  -- Folded
  hl(0, "Folded",       { fg = c.hint, bg = c.alt })
  hl(0, "FoldColumn",   { fg = c.hint, bg = c.alt })
  ...
  hl(0, "Cursor",       { fg = c.preproc, bg = c.preproc })
  hl(0, "lCursor",      { fg = c.preproc, bg = c.preproc })
  hl(0, "CursorIM",     { fg = c.preproc, bg = c.preproc })
  hl(0, "TermCursor",   { fg = c.preproc, bg = c.preproc })
  hl(0, "TermCursorNC", { fg = c.preproc, bg = c.preproc })

  -- Visual
  hl(0, "Visual",       { fg = c.bg, bg = c.preproc })
  hl(0, "VisualNOS",    { fg = 'NONE', bg = c.alt })

  -- Diff
  hl(0, "DiffText",     { fg = c.alt, bg = c.preproc })
  ...
  hl(0, "MatchParen",   { fg = c.info, bg = 'NONE', underline=true, })
  hl(0, "MatchWordCur", { fg = 'NONE', bg = 'NONE', underline=true, })
  hl(0, "MatchParenCur",{ fg = 'NONE', bg = 'NONE', underline=true, })

  -- Miscellaneous 
  hl(0, "LineNr",       { fg = c.hint, bg = 'NONE' })
  hl(0, "Conceal",      { fg = c.hint, bg = 'NONE' })
...
--------------------------------------------------------
  ...
  -- Search
  hl(0, "Search",       { fg = c.bg, bg = c.preproc })
...
--------------------------------------------------------
  ...
  hl(0, "Comment",      { fg = c.hint, bg = 'NONE' })
  hl(0, "Variable",     { fg = c.preproc, bg = 'NONE' })
  hl(0, "String",       { fg = c.info, bg = 'NONE' })
  hl(0, "Character",    { fg = c.preproc, bg = 'NONE' })
  ...
  hl(0, "function",     { fg = c.preproc, bg = 'none' })
  hl(0, "keyword",      { fg = c.preproc, bg = 'none' })
  hl(0, "conditional",  { fg = c.var, bg = 'none' })
  hl(0, "repeat",       { fg = c.var, bg = 'none' })
  hl(0, "operator",     { fg = c.info, bg = 'NONE' })
  ...
  hl(0, "Delimiter",    { fg = c.info, bg = 'NONE' })
  ...
  hl(0, "Identifier",   { fg = c.info, bg = 'NONE' })
  hl(0, "PreCondit",    { fg = c.preproc, bg = 'NONE' })
  hl(0, "Special",      { fg = c.hint, bg = 'NONE' })
...
--------------------------------------------------------
  ...
  hl(0, "TSConstMacro", { fg = c.hint, bg = 'NONE' })
  hl(0, "TSTypeBtin", { fg = c.hint, bg = 'NONE' })
  hl(0, "TSAnnotation", { fg = c.preproc, bg = 'NONE' })
  hl(0, "TSNamespace", { fg = c.preproc, bg = 'NONE' })
  hl(0, "TSSymbol", { fg = c.info, bg = 'NONE' })
  hl(0, "TSField", { fg = c.info, bg = 'NONE' })
  ...
  -- Telescope
  hl(0, "TelescopeSelection", { fg = c.preproc, bg = c.alt })
  hl(0, "TelescopeSelectionCaret", { fg = c.preproc, bg = c.alt })
  hl(0, "TelescopeMatching", { fg = c.preproc, bg = 'NONE', bold=true, italic=true, })
  hl(0, "TelescopeBorder", { fg = c.info, bg = 'NONE' })
  hl(0, "TelescopeNormal", { fg = c.preproc, bg = c.bg })
  hl(0, "TelescopePromptTitle", { fg = c.info, bg = 'NONE' })
  hl(0, "TelescopePromptPrefix", { fg = c.var, bg = 'NONE' })
  hl(0, "TelescopeResultsTitle", { fg = c.info, bg = 'NONE' })
  hl(0, "TelescopePreviewTitle", { fg = c.info, bg = 'NONE' })
  hl(0, "TelescopePromptCounter", { fg = c.var, bg = 'NONE' })
  hl(0, "TelescopePreviewHyphen", { fg = c.var, bg = 'NONE' })

  -- NvimTree
  hl(0, "NvimTreeFolderIcon", { link = 'Directory' })
  hl(0, "NvimTreeIndentMarker", { fg = c.fg, bg = 'NONE' })
  hl(0, "NvimTreeNormal", { fg = c.preproc, bg = c.bg })
  ...
  hl(0, "NvimTreeEmptyFolderName", { fg = c.info, bg = 'NONE', italic=true, })
  hl(0, "NvimTreeGitIgnored", { fg = c.info, bg = 'NONE', italic=true, })
  hl(0, "NvimTreeImageFile", { fg = c.fg, bg = 'NONE' })
  hl(0, "NvimTreeSpecialFile", { fg = c.hint, bg = 'NONE' })
  hl(0, "NvimTreeEndOfBuffer", { fg = c.bg, bg = 'NONE' })
  hl(0, "NvimTreeCursorLine", { fg = 'NONE', bg = c.alt })
  hl(0, "NvimTreeGitStaged", { fg = c.preproc, bg = 'NONE' })
  hl(0, "NvimTreeGitNew", { fg = c.preproc, bg = 'NONE' })
  ...
  hl(0, "NvimTreeRootFolder", { fg = c.info, bg = 'NONE', bold=true, })
  ...
  -- Buffer
  hl(0, "BufferCurrent", { fg = c.bg, bg = c.preproc })
  hl(0, "BufferCurrentIndex", { fg = c.info, bg = c.bg })
  ...
  hl(0, "BufferVisible", { fg = c.info, bg = c.bg })
  hl(0, "BufferVisibleIndex", { fg = c.info, bg = c.bg })
  ...
  hl(0, "BufferInactive", { fg = c.hint, bg = c.alt })
  hl(0, "BufferInactiveIndex", { fg = c.hint, bg = c.alt })
  hl(0, "BufferInactiveMod", { fg = c.info, bg = c.alt })
  ...
  -- Cmp
  hl(0, "CmpItemAbbrDeprecated", { fg = c.hint, bg = 'NONE', strikethrough=true, })
  ...
  hl(0, "CmpItemKindClass", { fg = c.preproc, bg = 'NONE' })
  ...
  -- Gps
  hl(0, "GpsNormal", { fg = c.hint, bg = '#1d1d1d' })
  hl(0, "GpsItemKindFunction", { fg = c.preproc, bg = 'NONE' })
  hl(0, "GpsItemKindMethod", { fg = c.preproc, bg = 'NONE' })
  hl(0, "GpsItemKindConstructor", { fg = c.hint, bg = 'NONE' })
  hl(0, "GpsItemKindClass", { fg = c.hint, bg = 'NONE' })
  hl(0, "GpsItemKindEnum", { fg = c.hint, bg = 'NONE' })
  hl(0, "GpsItemKindEvent", { fg = c.preproc, bg = 'NONE' })
  hl(0, "GpsItemKindInterface", { fg = c.info, bg = 'NONE' })
  hl(0, "GpsItemKindStruct", { fg = c.preproc, bg = 'NONE' })
  hl(0, "GpsItemKindVariable", { fg = c.preproc, bg = 'NONE' })
  hl(0, "GpsItemKindField", { fg = c.preproc, bg = 'NONE' })
  hl(0, "GpsItemKindProperty", { fg = c.preproc, bg = 'NONE' })
  hl(0, "GpsItemKindEnumMember", { fg = c.info, bg = 'NONE' })
  hl(0, "GpsItemKindConstant", { fg = c.preproc, bg = 'NONE' })
  hl(0, "GpsItemKindKeyword", { fg = c.info, bg = 'NONE' })
  hl(0, "GpsItemKindModule", { fg = c.info, bg = 'NONE' })
  hl(0, "GpsItemKindValue", { fg = c.info, bg = 'NONE' })
  hl(0, "GpsItemKindUnit", { fg = c.info, bg = 'NONE' })
  hl(0, "GpsItemKindText", { fg = c.info, bg = 'NONE' })
  hl(0, "GpsItemKindSnippet", { fg = c.info, bg = 'NONE' })
  hl(0, "GpsItemKindFile", { fg = c.info, bg = 'NONE' })
  hl(0, "GpsItemKindFolder", { fg = c.info, bg = 'NONE' })
  hl(0, "GpsItemKindColor", { fg = c.info, bg = 'NONE' })
  hl(0, "GpsItemKindReference", { fg = c.info, bg = 'NONE' })
  hl(0, "GpsItemKindOperator", { fg = c.info, bg = 'NONE' })
  ...
  hl(0, "luaFunc", { fg = c.hint, bg = 'NONE' })
  hl(0, "luaFunction", { fg = c.preproc, bg = 'NONE' })
  ...
  hl(0, "htmlComment", { fg = c.preproc, bg = 'NONE' })
  hl(0, "htmlLink", { fg = c.hint, bg = 'NONE', underline=true, })
  hl(0, "cssBraces", { fg = c.info, bg = 'NONE' })
