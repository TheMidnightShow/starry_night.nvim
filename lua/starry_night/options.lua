...
M.options = function(c)
  ...
  --------------------------------------------------------
    ...
    { "Comment",      { fg = c.comment, bg = "NONE" } },
    { "Variable",     { fg = c.type, bg = "NONE" } },
    { "String",       { fg = c.str, bg = "NONE" } },
    { "Character",    { fg = c.var, bg = "NONE" } },
    { "Number",       { fg = c.num, bg = "NONE" } },
    { "Float",        { fg = c.num, bg = 'none' } },

    { "boolean",      { fg = c.warn, bg = 'none' } },
    { "constant",     { fg = c.var, bg = 'none' } },
    { "type",         { fg = c.type, bg = 'none' } },

    { "function",     { fg = c.var, bg = 'none' } },
    { "keyword",      { fg = c.var, bg = 'none' } },
    { "conditional",  { fg = c.conditional, bg = 'none' } },
    { "repeat",       { fg = c.conditional, bg = 'none' } },
    { "operator",     { fg = c.var, bg = "NONE" } },
...
M.setup = function(color)
  if color == "dark" then
    Theme = require("starry_night.colors").dark
  elseif color == "light" then
    Theme = require("starry_night.colors").light
  end

  for _,v in pairs(M.options(Theme)) do
